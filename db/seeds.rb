...
g1 = Genre.create!(name: 'Action', genre_id: 28, movie_id: mov3.id, mood_id: m2.id)
g2 = Genre.create!(name: 'Adventure', genre_id: 12)
g3 = Genre.create!(name: 'Animation', genre_id: 16)
g4 = Genre.create!(name: 'Comedy', genre_id: 35, mood_id: m22.id)
g5 = Genre.create!(name: 'Crime', genre_id: 80)
g6 = Genre.create!(name: 'Documentary', genre_id: 99)
g7 = Genre.create!(name: 'Drama', genre_id: 18)
g8 = Genre.create!(name: 'Family', genre_id: 10751)
g9 = Genre.create!(name: 'Fantasy', genre_id: 14, movie_id: mov6.id)
g10 = Genre.create!(name: 'Foreign', genre_id: 10769)
g11 = Genre.create!(name: 'History', genre_id: 36)
g12 = Genre.create!(name: 'Horror', genre_id: 27)
g13 = Genre.create!(name: 'Music', genre_id: 10402)
g14 = Genre.create!(name: 'Mystery', genre_id: 9648)
g15 = Genre.create!(name: 'Romance', genre_id: 10749)
g16 = Genre.create!(name: 'Science Fiction', genre_id: 878)
g17 = Genre.create!(name: 'Thriller', genre_id: 10770)
g18 = Genre.create!(name: 'War', genre_id: 10752)
g19 = Genre.create!(name: 'Western', genre_id: 37)
